...
const duration_1 = __webpack_require__(/*! ./duration */ "./src/duration.ts");
...
const info_1 = __webpack_require__(/*! ./info */ "./src/info.ts");
const formatter_1 = __webpack_require__(/*! ./impl/formatter */ "./src/impl/formatter.ts");
const fixedOffsetZone_1 = __webpack_require__(/*! ./zones/fixedOffsetZone */ "./src/zones/fixedOffsetZone.ts");
const locale_1 = __webpack_require__(/*! ./impl/locale */ "./src/impl/locale.ts");
const util_1 = __webpack_require__(/*! ./impl/util */ "./src/impl/util.ts");
const zoneUtil_1 = __webpack_require__(/*! ./impl/zoneUtil */ "./src/impl/zoneUtil.ts");
const diff_1 = __webpack_require__(/*! ./impl/diff */ "./src/impl/diff.ts");
const regexParser_1 = __webpack_require__(/*! ./impl/regexParser */ "./src/impl/regexParser.ts");
const tokenParser_1 = __webpack_require__(/*! ./impl/tokenParser */ "./src/impl/tokenParser.ts");
const conversions_1 = __webpack_require__(/*! ./impl/conversions */ "./src/impl/conversions.ts");
const Formats = tslib_1.__importStar(__webpack_require__(/*! ./impl/formats */ "./src/impl/formats.ts"));
const errors_1 = __webpack_require__(/*! ./errors */ "./src/errors.ts");
const invalid_1 = __webpack_require__(/*! ./types/invalid */ "./src/types/invalid.ts");
...
function parseDataToDateTime(parsed, parsedZone, opts, format, text, specificOffset) {
    ...
    if ((parsed && Object.keys(parsed).length !== 0) || parsedZone) {
        ...
        return DateTime.invalid(new invalid_1.Invalid("unparsable", `the input "${text}" can't be parsed as ${format}`));
    }
}
...
function normalizeUnit(unit) {
    const normalized = util_1.PLURAL_MAPPING[unit.toLowerCase()];
    if (!normalized) {
...
class DateTime {
     ...
     */
    static DATETIME_FULL = Formats.DATETIME_FULL;
    /**
     * {@link DateTime#toLocaleString} format like 'October 14, 1983, 9:30:33 AM EDT'. Only 12-hour if the locale is.
     */
    static DATETIME_FULL_WITH_SECONDS = Formats.DATETIME_FULL_WITH_SECONDS;
    /**
     * {@link DateTime#toLocaleString} format like 'Friday, October 14, 1983, 9:30 AM Eastern Daylight Time'. Only 12-hour if the locale is.
     */
    static DATETIME_HUGE = Formats.DATETIME_HUGE;
    /**
     * {@link DateTime#toLocaleString} format like 'Friday, October 14, 1983, 9:30:33 AM Eastern Daylight Time'. Only 12-hour if the locale is.
     */
    static DATETIME_HUGE_WITH_SECONDS = Formats.DATETIME_HUGE_WITH_SECONDS;
    /**
     * {@link DateTime#toLocaleString} format like 'Oct 14, 1983, 9:30 AM'. Only 12-hour if the locale is.
     */
    static DATETIME_MED = Formats.DATETIME_MED;
    /**
     * {@link DateTime#toLocaleString} format like 'Oct 14, 1983, 9:30:33 AM'. Only 12-hour if the locale is.
     */
    static DATETIME_MED_WITH_SECONDS = Formats.DATETIME_MED_WITH_SECONDS;
    /**
     * {@link DateTime#toLocaleString} format like 'Fri, 14 Oct 1983, 9:30 AM'. Only 12-hour if the locale is.
     */
    static DATETIME_MED_WITH_WEEKDAY = Formats.DATETIME_MED_WITH_WEEKDAY;
    /**
     * {@link DateTime#toLocaleString} format like "10/14/1983, 9:30 AM". Only 12-hour if the locale is.
     */
    static DATETIME_SHORT = Formats.DATETIME_SHORT;
    /**
     * {@link DateTime#toLocaleString} format like "10/14/1983, 9:30:33 AM". Only 12-hour if the locale is.
     */
    static DATETIME_SHORT_WITH_SECONDS = Formats.DATETIME_SHORT_WITH_SECONDS;
    /**
     * {@link DateTime#toLocaleString} format like 'October 14, 1983'
     */
    static DATE_FULL = Formats.DATE_FULL;
    /**
     * {@link DateTime#toLocaleString} format like 'Friday, October 14, 1983'
     */
    static DATE_HUGE = Formats.DATE_HUGE;
    /**
     * {@link DateTime#toLocaleString} format like 'Oct 14, 1983'
     */
    static DATE_MED = Formats.DATE_MED;
    /**
     * {@link DateTime#toLocaleString} format like 'Fri, Oct 14, 1983'
     */
    static DATE_MED_WITH_WEEKDAY = Formats.DATE_MED_WITH_WEEKDAY;
    /**
     * {@link DateTime#toLocaleString} format like 10/14/1983
     */
    static DATE_SHORT = Formats.DATE_SHORT;
    /**
     * {@link DateTime#toLocaleString} format like "09:30", always 24-hour.
     */
    static TIME_24_SIMPLE = Formats.TIME_24_SIMPLE;
    /**
     * {@link DateTime#toLocaleString} format like "09:30:23 Eastern Daylight Time", always 24-hour.
     */
    static TIME_24_WITH_LONG_OFFSET = Formats.TIME_24_WITH_LONG_OFFSET;
    /**
     * {@link DateTime#toLocaleString} format like "09:30:23", always 24-hour.
     */
    static TIME_24_WITH_SECONDS = Formats.TIME_24_WITH_SECONDS;
    /**
     * {@link DateTime#toLocaleString} format like "09:30:23 EDT", always 24-hour.
     */
    static TIME_24_WITH_SHORT_OFFSET = Formats.TIME_24_WITH_SHORT_OFFSET;
    /**
     * {@link DateTime#toLocaleString} format like "09:30 AM". Only 12-hour if the locale is.
     */
    static TIME_SIMPLE = Formats.TIME_SIMPLE;
    /**
     * {@link DateTime#toLocaleString} format like "09:30:23 AM Eastern Daylight Time". Only 12-hour if the locale is.
     */
    static TIME_WITH_LONG_OFFSET = Formats.TIME_WITH_LONG_OFFSET;
    /**
     * {@link DateTime#toLocaleString} format like "09:30:23 AM". Only 12-hour if the locale is.
     */
    static TIME_WITH_SECONDS = Formats.TIME_WITH_SECONDS;
    /**
     * {@link DateTime#toLocaleString} format like "09:30:23 AM EDT". Only 12-hour if the locale is.
     */
    static TIME_WITH_SHORT_OFFSET = Formats.TIME_WITH_SHORT_OFFSET;
    static _zoneOffsetGuessCache = new Map();
     ...
     */
    constructor(config) {
        const zone = config.zone || settings_1.Settings.defaultZone;
        ...
        if (!invalid) {
            ...
            if (unchanged) {
                ...
                const ot = (0, util_1.isNumber)(config.o) && !config.old ? config.o : zone.offset(this.ts);
    ...
    static buildFormatParser(fmt, options = {}) {
        const { locale = null, numberingSystem = null } = options, localeToUse = locale_1.Locale.fromOpts({
            locale,
            numberingSystem,
            defaultToEN: true
        });
    ...
    static expandFormat(fmt, localeOpts = {}) {
        const expanded = (0, tokenParser_1.expandMacroTokens)(formatter_1.Formatter.parseFormat(fmt), locale_1.Locale.fromObject(localeOpts));
    ...
    static fromFormat(text, fmt, opts = {}) {
        ...
        const { locale, numberingSystem } = opts, localeToUse = locale_1.Locale.fromOpts({
            locale,
            numberingSystem,
            defaultToEN: true
        }), [vals, parsedZone, specificOffset, invalid] = (0, tokenParser_1.parseFromTokens)(localeToUse, text, fmt);
        if (invalid) {
    ...
    static fromFormatExplain(text, fmt, options = {}) {
        const { locale, numberingSystem } = options, localeToUse = locale_1.Locale.fromOpts({
            locale,
            numberingSystem,
            defaultToEN: true
        });
    ...
    static fromFormatParser(text, formatParser, opts = {}) {
        ...
        const { locale = null, numberingSystem = null } = opts, localeToUse = locale_1.Locale.fromOpts({
            locale,
            numberingSystem,
            defaultToEN: true
        });
        if (!localeToUse.equals(formatParser.locale)) {
            throw new errors_1.InvalidArgumentError(`fromFormatParser called with a locale of ${localeToUse}, ` +
    ...
    static fromHTTP(text, opts = {}) {
        const [vals, parsedZone] = (0, regexParser_1.parseHTTPDate)(text);
    ...
    static fromISO(text, opts = {}) {
        const [vals, parsedZone] = (0, regexParser_1.parseISODate)(text);
    ...
    static fromJSDate(date, options = {}) {
        const ts = (0, util_1.isDate)(date) ? date.valueOf() : NaN;
        if (Number.isNaN(ts)) {
            return DateTime.invalid("invalid input");
        }
        const zoneToUse = (0, zoneUtil_1.normalizeZone)(options.zone, settings_1.Settings.defaultZone);
    ...
    static fromMillis(milliseconds, options = {}) {
        if (!(0, util_1.isNumber)(milliseconds)) {
            throw new errors_1.InvalidArgumentError(`fromMillis requires a numerical input, but received a ${typeof milliseconds} with value ${milliseconds}`);
        }
    ...
    static fromObject(obj = {}, opts = {}) {
        const zoneToUse = (0, zoneUtil_1.normalizeZone)(opts.zone, settings_1.Settings.defaultZone);
        if (!zoneToUse.isValid) {
            return DateTime.invalid(DateTime._unsupportedZone(zoneToUse));
        }
        const loc = locale_1.Locale.fromObject(opts);
        const normalized = (0, util_1.normalizeObject)(obj, normalizeUnit);
        const tsNow = settings_1.Settings.now(), offsetProvis = (0, util_1.isNumber)(opts.specificOffset)
            ? opts.specificOffset
        ...
        const { minDaysInFirstWeek, startOfWeek } = (0, conversions_1.usesLocalWeekValues)(normalized, loc);
    ...
    static fromRFC2822(text, opts = {}) {
        const [vals, parsedZone] = (0, regexParser_1.parseRFC2822Date)(text);
    ...
    static fromSQL(text, opts = {}) {
        const [vals, parsedZone] = (0, regexParser_1.parseSQL)(text);
    ...
    static invalid(reason, explanation) {
        ...
        const invalid = reason instanceof invalid_1.Invalid ? reason : new invalid_1.Invalid(reason, explanation);
    ...
    static max(...dateTimes) {
        ...
        return (0, util_1.bestBy)(dateTimes, i => i.valueOf(), Math.max);
    }
    static min(...dateTimes) {
        if (!dateTimes.every(DateTime.isDateTime)) {
            throw new errors_1.InvalidArgumentError("min requires all arguments be DateTimes");
        }
        return (0, util_1.bestBy)(dateTimes, (i) => i.valueOf(), Math.min);
    }
    /**
    ...
    static parseFormatForOpts(formatOpts, localeOpts = {}) {
        const tokenList = (0, tokenParser_1.formatOptsToTokens)(formatOpts, locale_1.Locale.fromObject(localeOpts));
    ...
    static _buildObject(config, units, defaultValues, objNow) {
        ...
        const invalid = higherOrderInvalid || (0, conversions_1.hasInvalidTimeData)(config.normalized);
        if (invalid) {
            return DateTime.invalid(invalid);
        }
    ...
    static _diffRelative(start, end, opts) {
        const round = (0, util_1.isUndefined)(opts.round) ? true : opts.round, format = (c, unit) => {
    ...
    static _quickDT(obj, opts) {
        const zone = (0, zoneUtil_1.normalizeZone)(opts.zone, settings_1.Settings.defaultZone);
        if (!zone.isValid) {
            return DateTime.invalid(this._unsupportedZone(zone));
        }
        const loc = locale_1.Locale.fromObject(opts);
        const tsNow = settings_1.Settings.now();
        let ts, o;
        ...
        if ((0, util_1.isDefined)(obj.year)) {
            ...
            const invalid = (0, conversions_1.hasInvalidGregorianData)(obj) || (0, conversions_1.hasInvalidTimeData)(obj);
            if (invalid) {
                return DateTime.invalid(invalid);
            }
    ...
    static _unsupportedZone(zone) {
        return new invalid_1.Invalid("unsupported zone", `the zone "${zone.name}" is not supported`);
    }
    // PUBLIC
    /**
    ...
    diff(otherDateTime, unit = "milliseconds", opts = {}) {
        ...
        const units = (0, util_1.maybeArray)(unit).map(duration_1.Duration.normalizeUnit), otherIsLater = otherDateTime.valueOf() > this.valueOf(), earlier = otherIsLater ? this : otherDateTime, later = otherIsLater ? otherDateTime : this, diffed = (0, diff_1.diff)(earlier, later, units, {
            locale: this.locale,
    ...
    getPossibleOffsets() {
        ...
        const localTS = (0, util_1.objToLocalTS)(this._c);
    ...
    minus(duration) {
        ...
        const dur = duration_1.Duration.fromDurationLike(duration).negate();
    ...
    plus(duration) {
        ...
        const dur = duration_1.Duration.fromDurationLike(duration);
        return this._clone(this._adjustTime(dur));
    }
    /**
    ...
    resolvedLocaleOptions(opts = {}) {
        const { locale, numberingSystem, calendar } = formatter_1.Formatter.create(this._loc.clone(opts), opts).resolvedOptions(this);
    ...
    set(values) {
        ...
        const normalized = (0, util_1.normalizeObject)(values, normalizeUnit);
        const { minDaysInFirstWeek, startOfWeek } = (0, conversions_1.usesLocalWeekValues)(normalized, this.loc);
        const settingWeekStuff = (0, util_1.isDefined)(normalized.weekYear) || (0, util_1.isDefined)(normalized.weekNumber) || (0, util_1.isDefined)(normalized.weekday);
        ...
        let mixed;
        if (settingWeekStuff) {
            mixed = (0, conversions_1.weekToGregorian)({ ...(0, conversions_1.gregorianToWeek)(this._c, minDaysInFirstWeek, startOfWeek), ...normalized }, minDaysInFirstWeek, startOfWeek);
        }
        else if (!(0, util_1.isUndefined)(normalized.ordinal)) {
            mixed = (0, conversions_1.ordinalToGregorian)({ ...(0, conversions_1.gregorianToOrdinal)(this._c), ...normalized });
        }
        else {
    ...
    startOf(unit, { useLocaleWeeks = false } = {}) {
        ...
        const o = {}, normalizedUnit = duration_1.Duration.normalizeUnit(unit);
    ...
    toRelative(options = {}) {
        ...
        return DateTime._diffRelative(base, this.plus(padding), {
            ...options,
            numeric: "always",
            units,
            unit
    ...
    toRelativeCalendar(options = {}) {
        ...
        return DateTime._diffRelative(options.base || DateTime.fromObject({}, { zone: this.zone }), this, {
            ...options,
            numeric: "auto",
     ...
     */
    _adjustTime(dur) {
        const previousOffset = this._o, year = this._c.year + Math.trunc(dur.years), month = this._c.month + Math.trunc(dur.months) + Math.trunc(dur.quarters) * 3, c = {
            ...this._c,
            year,
            month,
            day: Math.min(this._c.day, (0, util_1.daysInMonth)(year, month)) +
                Math.trunc(dur.days) +
    ...
    _toISOTime(extended, suppressSeconds, suppressMilliseconds, includeOffset, extendedZone) {
        let c = (0, util_1.padStart)(this._c.hour);
        if (extended) {
            c += ":";
...
function durationToMillis(matrix, vals) {
    ...
    for (const unit of util_1.REVERSE_ORDERED_UNITS.slice(1)) {
        if (vals[unit]) {
...
function normalizeValues(matrix, vals) {
    ...
    util_1.REVERSE_ORDERED_UNITS.reduce((previous, current) => {
    ...
    util_1.ORDERED_UNITS.reduce((previous, current) => {
        if (!(0, util_1.isUndefined)(vals[current])) {
            if (previous) {
...
class Duration {
    ...
    static fromDurationLike(durationLike) {
        if ((0, util_1.isNumber)(durationLike)) {
            ...
            throw new errors_1.InvalidArgumentError(`Unknown duration argument ${durationLike} of type ${typeof durationLike}`);
        }
    }
    /**
     ...
     */
    static fromISO(text, opts) {
        const [parsed] = (0, regexParser_1.parseISODuration)(text);
        if (parsed) {
    ...
    static fromISOTime(text, opts = {}) {
        const [parsed] = (0, regexParser_1.parseISOTimeOnly)(text);
        if (parsed) {
            return Duration.fromObject(parsed, opts);
        }
        else {
    ...
    static fromObject(obj, opts = {}) {
        if (obj == null || typeof obj !== "object") {
            throw new errors_1.InvalidArgumentError(`Duration.fromObject: argument expected to be an object, got ${obj === null ? "null" : typeof obj}`);
        }
        return new Duration({
    ...
    equals(other) {
        ...
        for (const u of util_1.ORDERED_UNITS) {
    ...
    getMaxUnit(onlyHuman = !1) {
        const refUnits = onlyHuman ? util_1.HUMAN_ORDERED_UNITS : util_1.ORDERED_UNITS;
        const val = this.shiftTo(...refUnits).toObject();
        return refUnits.find((k) => (val[k] || 0) > 0) || util_1.REVERSE_ORDERED_UNITS[0];
    }
    /**
    ...
    mapUnits(fn) {
        ...
        Object.keys(this._values).forEach((unit) => {
            result[unit] = (0, util_1.asNumber)(fn(this._values[unit], unit));
        });
    ...
    plus(duration) {
        ...
        util_1.ORDERED_UNITS.forEach(unit => {
    ...
    set(values) {
        ...
        const mixed = {
            ...this._values,
            ...(0, util_1.normalizeObject)(values, Duration.normalizeUnit)
        };
    ...
    shiftTo(...units) {
        ...
        let lastUnit;
        util_1.ORDERED_UNITS.forEach((k) => {
    ...
    toHuman(opts = {}) {
        ...
        const refUnits = !!opts.onlyHumanUnits ? util_1.HUMAN_ORDERED_UNITS : util_1.ORDERED_UNITS;
    ...
    toISOTime(opts = {}) {
        ...
        const dateTime = datetime_1.DateTime.fromMillis(millis, { zone: "UTC" });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.usesLocalWeekValues = exports.isoWeekdayToLocal = exports.hasInvalidTimeData = exports.hasInvalidGregorianData = exports.hasInvalidOrdinalData = exports.hasInvalidWeekData = exports.ordinalToGregorian = exports.gregorianToOrdinal = exports.weekToGregorian = exports.gregorianToWeek = exports.dayOfWeek = void 0;
const util_1 = __webpack_require__(/*! ./util */ "./src/impl/util.ts");
const invalid_1 = __webpack_require__(/*! ../types/invalid */ "./src/types/invalid.ts");
const errors_1 = __webpack_require__(/*! ../errors */ "./src/errors.ts");
const nonLeapLadder = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
const leapLadder = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335];
function unitOutOfRange(unit, value) {
    return new invalid_1.Invalid("unit out of range", `you specified ${value} (of type ${typeof value}) as a ${unit}, which is invalid`);
}
function computeOrdinal(year, month, day) {
    return day + ((0, util_1.isLeapYear)(year) ? leapLadder : nonLeapLadder)[month - 1];
}
function uncomputeOrdinal(year, ordinal) {
    const table = (0, util_1.isLeapYear)(year) ? leapLadder : nonLeapLadder;
...
function gregorianToWeek(gregObj, minDaysInFirstWeek = util_1.FALLBACK_WEEK_SETTINGS.minimalDays, startOfWeek = util_1.FALLBACK_WEEK_SETTINGS.firstDay) {
    ...
    return { weekYear, weekNumber, weekday, ...(0, util_1.timeObject)(gregObj) };
}
exports.gregorianToWeek = gregorianToWeek;
function weekToGregorian(weekData, minDaysInFirstWeek = util_1.FALLBACK_WEEK_SETTINGS.minimalDays, startOfWeek = util_1.FALLBACK_WEEK_SETTINGS.firstDay) {
    const { weekYear, weekNumber, weekday } = weekData;
    const weekdayOfJan4 = isoWeekdayToLocal(dayOfWeek(weekYear, 1, minDaysInFirstWeek), startOfWeek);
    const yearInDays = (0, util_1.daysInYear)(weekYear);
    ...
    return { year, month, day, ...(0, util_1.timeObject)(weekData) };
}
exports.weekToGregorian = weekToGregorian;
function gregorianToOrdinal(gregData) {
    const { year, month, day } = gregData;
    const ordinal = computeOrdinal(year, month, day);
    return { year, ordinal, ...(0, util_1.timeObject)(gregData) };
}
exports.gregorianToOrdinal = gregorianToOrdinal;
function ordinalToGregorian(ordinalData) {
    const { year, ordinal } = ordinalData;
    const { month, day } = uncomputeOrdinal(year, ordinal);
    return { year, month, day, ...(0, util_1.timeObject)(ordinalData) };
}
exports.ordinalToGregorian = ordinalToGregorian;
function hasInvalidWeekData(obj, minDaysInFirstWeek = 4, startOfWeek = 1) {
    const validYear = (0, util_1.isInteger)(obj.weekYear), validWeek = (0, util_1.integerBetween)(obj.weekNumber, 1, (0, util_1.weeksInWeekYear)(obj.weekYear, minDaysInFirstWeek, startOfWeek)), validWeekday = (0, util_1.integerBetween)(obj.weekday, 1, 7);
    if (!validYear) {
...
function hasInvalidOrdinalData(obj) {
    const validYear = (0, util_1.isInteger)(obj.year), validOrdinal = (0, util_1.integerBetween)(obj.ordinal, 1, (0, util_1.daysInYear)(obj.year));
    if (!validYear) {
...
function hasInvalidGregorianData(obj) {
    const validYear = (0, util_1.isInteger)(obj.year), validMonth = (0, util_1.integerBetween)(obj.month, 1, 12), validDay = (0, util_1.integerBetween)(obj.day, 1, (0, util_1.daysInMonth)(obj.year, obj.month));
    if (!validYear) {
        return unitOutOfRange("year", obj.year);
    }
    else if (!validMonth) {
...
function hasInvalidTimeData(obj) {
    ...
    const validHour = (0, util_1.integerBetween)(hour, 0, 23) ||
...
function usesLocalWeekValues(obj, loc) {
    const hasLocaleWeekData = (0, util_1.isDefined)(obj.localWeekday) ||
        (0, util_1.isDefined)(obj.localWeekNumber) ||
        (0, util_1.isDefined)(obj.localWeekYear);
    if (hasLocaleWeekData) {
        const hasIsoWeekData = (0, util_1.isDefined)(obj.weekday) || (0, util_1.isDefined)(obj.weekNumber) || (0, util_1.isDefined)(obj.weekYear);
        if (hasIsoWeekData) {
...
const diff = (earlier, later, units, opts) => {
    ...
    const duration = duration_1.Duration.fromObject(results, opts);
    if (lowerOrderUnits.length > 0) {
        return duration_1.Duration.fromMillis(remainingMillis, opts)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.digitRegex = exports.resetDigitRegexCache = exports.parseDigits = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.formatString = exports.formatRelativeTime = exports.eraForDateTime = exports.monthForDateTime = exports.weekdayForDateTime = exports.meridiemForDateTime = exports.eras = exports.erasNarrow = exports.erasShort = exports.erasLong = exports.meridiems = exports.weekdays = exports.weekdaysNarrow = exports.weekdaysShort = exports.weekdaysLong = exports.months = exports.monthsNarrow = exports.monthsShort = exports.monthsLong = void 0;
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const Formats = tslib_1.__importStar(__webpack_require__(/*! ./formats */ "./src/impl/formats.ts"));
const util_1 = __webpack_require__(/*! ./util */ "./src/impl/util.ts");
const duration_1 = __webpack_require__(/*! ../duration */ "./src/duration.ts");
...
function months(length) {
    switch (length) {
        case "narrow":
            return [...exports.monthsNarrow];
        case "short":
            return [...exports.monthsShort];
        case "long":
            return [...exports.monthsLong];
        case "numeric":
...
function weekdays(length) {
    switch (length) {
        case "narrow":
            return [...exports.weekdaysNarrow];
        case "short":
            return [...exports.weekdaysShort];
        case "long":
            return [...exports.weekdaysLong];
        case "numeric":
...
function eras(length) {
    switch (length) {
        case "narrow":
            return [...exports.erasNarrow];
        case "short":
            return [...exports.erasShort];
        case "long":
            return [...exports.erasLong];
    }
}
exports.eras = eras;
...
function formatRelativeTime(unit, count, numeric = "always", narrow = false) {
    ...
    const normalizedUnit = duration_1.Duration.normalizeUnit(unit), unitTexts = units[normalizedUnit], lastable = ["hours", "minutes", "seconds"].indexOf(normalizedUnit) === -1;
...
function formatString(knownFormat) {
    ...
    const filtered = (0, util_1.pick)(knownFormat, [
        "weekday",
        "era",
        "year",
        "month",
...
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const English = tslib_1.__importStar(__webpack_require__(/*! ./english */ "./src/impl/english.ts"));
const Formats = tslib_1.__importStar(__webpack_require__(/*! ./formats */ "./src/impl/formats.ts"));
const util_1 = __webpack_require__(/*! ./util */ "./src/impl/util.ts");
...
const settings_1 = __webpack_require__(/*! ../settings */ "./src/settings.ts");
const datetime_1 = __webpack_require__(/*! ../datetime */ "./src/datetime.ts");
const IANAZone_1 = __webpack_require__(/*! ../zones/IANAZone */ "./src/zones/IANAZone.ts");
const intl_next_1 = tslib_1.__importDefault(__webpack_require__(/*! ../types/intl-next */ "./src/types/intl-next.ts"));
// todo - remap caching
let intlLFCache = {};
...
function mapMonths(f) {
    const ms = [];
    for (let i = 1; i <= 12; i++) {
        const dt = datetime_1.DateTime.utc(2009, i, 1);
        ms.push(f(dt));
    }
    return ms;
}
function mapWeekdays(f) {
    const ms = [];
    for (let i = 1; i <= 7; i++) {
        const dt = datetime_1.DateTime.utc(2016, 11, 13 + i);
        ms.push(f(dt));
    }
    return ms;
}
...
class PolyNumberFormatter {
    ...
    format(i) {
        if (this._inf) {
            ...
            const fixed = this._floor ? Math.floor(i) : (0, util_1.roundTo)(i, 3);
...
class Locale {
    ...
    static create(locale, numberingSystem, outputCalendar, weekSettings, defaultToEN = !1) {
        const specifiedLocale = locale || settings_1.Settings.defaultLocale;
        // the system locale is useful for human-readable strings but annoying for parsing/formatting known formats
        const localeR = specifiedLocale || (defaultToEN ? "en-US" : systemLocale());
        const numberingSystemR = numberingSystem || settings_1.Settings.defaultNumberingSystem;
        const outputCalendarR = outputCalendar || settings_1.Settings.defaultOutputCalendar;
        const weekSettingsR = (0, util_1.validateWeekSettings)(weekSettings) || settings_1.Settings.defaultWeekSettings;
    ...
    eras(length) {
        return listStuff(this, length, English.eras, len => {
            ...
            if (!this._eraCache[len]) {
                this._eraCache[len] = [datetime_1.DateTime.utc(-40, 1, 1), datetime_1.DateTime.utc(2017, 1, 1)].map(dt => this.extract(dt, intl, "era"));
            }
    ...
    isEnglish() {
        ...
        !!~["en", "en-us"].indexOf(this.locale.toLowerCase()) ||
            new intl_next_1.default.DateTimeFormat(this._intl).resolvedOptions().locale.startsWith("en-us"));
    }
    listFormatter(opts = {}) {
    ...
    _getCachedWeekInfo(locString) {
        ...
        if (!data) {
            const locale = new intl_next_1.default.Locale(locString);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.parseSQL = exports.parseRFC2822Date = exports.parseISOTimeOnly = exports.parseISODuration = exports.parseISODate = exports.parseHTTPDate = exports.IANA_REGEX = void 0;
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const util_1 = __webpack_require__(/*! ./util */ "./src/impl/util.ts");
const English = tslib_1.__importStar(__webpack_require__(/*! ./english */ "./src/impl/english.ts"));
const fixedOffsetZone_1 = __webpack_require__(/*! ../zones/fixedOffsetZone */ "./src/zones/fixedOffsetZone.ts");
...
const isoExtendedZone = `(?:${offsetRegex.source}?(?:\\[(${exports.IANA_REGEX.source})\\])?)?`;
...
const sqlTimeRegex = RegExp(`${isoTimeBaseRegex.source} ?(?:${offsetRegex.source}|(${exports.IANA_REGEX.source}))?`);
...
function extractISOOffset(match, cursor) {
    const local = !match[cursor] && !match[cursor + 1], fullOffset = (0, util_1.signedOffset)(match[cursor + 1], match[cursor + 2]), zone = local ? null : fixedOffsetZone_1.FixedOffsetZone.instance(fullOffset);
    return [{}, zone, cursor + 3];
}
function extractIANAZone(match, cursor) {
    const zone = match[cursor] ? IANAZone_1.IANAZone.create(match[cursor]) : null;
...
function fromStrings(weekdayStr, yearStr, monthStr, dayStr, hourStr, minuteStr, secondStr) {
    ...
    const year = yearStr.length === 2 ? (0, util_1.untruncateYear)((0, util_1.parseInteger)(yearStr)) : (0, util_1.parseInteger)(yearStr);
    return {
        year,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.formatOptsToTokens = exports.parseFromTokens = exports.sanitizeSpaces = exports.explainFromTokens = exports.TokenParser = exports.expandMacroTokens = void 0;
const util_1 = __webpack_require__(/*! ./util */ "./src/impl/util.ts");
const formatter_1 = __webpack_require__(/*! ./formatter */ "./src/impl/formatter.ts");
const fixedOffsetZone_1 = __webpack_require__(/*! ../zones/fixedOffsetZone */ "./src/zones/fixedOffsetZone.ts");
const IANAZone_1 = __webpack_require__(/*! ../zones/IANAZone */ "./src/zones/IANAZone.ts");
const digits_1 = __webpack_require__(/*! ./digits */ "./src/impl/digits.ts");
const datetime_1 = __webpack_require__(/*! ../datetime */ "./src/datetime.ts");
const errors_1 = __webpack_require__(/*! ../errors */ "./src/errors.ts");
const missingFtp = "missing Intl.DateTimeFormat.formatToParts support";
function intUnit(regex, post = (i) => i) {
    return { regex, deser: ([s]) => post((0, digits_1.parseDigits)(s)) };
}
...
function offset(regex, groups) {
    return { regex, deser: ([, h, m]) => (0, util_1.signedOffset)(h, m), groups };
}
...
function unitForToken(token, loc) {
    const one = (0, digits_1.digitRegex)(loc), two = (0, digits_1.digitRegex)(loc, "{2}"), three = (0, digits_1.digitRegex)(loc, "{3}"), four = (0, digits_1.digitRegex)(loc, "{4}"), six = (0, digits_1.digitRegex)(loc, "{6}"), oneOrTwo = (0, digits_1.digitRegex)(loc, "{1,2}"), oneToThree = (0, digits_1.digitRegex)(loc, "{1,3}"), oneToSix = (0, digits_1.digitRegex)(loc, "{1,6}"), oneToNine = (0, digits_1.digitRegex)(loc, "{1,9}"), twoToFour = (0, digits_1.digitRegex)(loc, "{2,4}"), fourToSix = (0, digits_1.digitRegex)(loc, "{4,6}"), literal = (t) => ({
...
function maybeExpandMacroToken(token, locale) {
    ...
    const formatOpts = formatter_1.Formatter.macroTokenToFormatOpts(token.val);
...
function formatOptsToTokens(formatOpts, locale) {
    ...
    const formatter = formatter_1.Formatter.create(locale, formatOpts);
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.FALLBACK_WEEK_SETTINGS = exports.PLURAL_MAPPING = exports.HUMAN_ORDERED_UNITS = exports.REVERSE_ORDERED_UNITS = exports.ORDERED_UNITS = exports.timeObject = exports.formatOffset = exports.normalizeObject = exports.asNumber = exports.signedOffset = exports.parseZoneInfo = exports.untruncateYear = exports.weeksInWeekYear = exports.objToLocalTS = exports.daysInMonth = exports.daysInYear = exports.isLeapYear = exports.roundTo = exports.parseMillis = exports.parseFloating = exports.parseInteger = exports.padStart = exports.floorMod = exports.integerBetween = exports.validateWeekSettings = exports.pick = exports.bestBy = exports.maybeArray = exports.hasLocaleWeekInfo = exports.hasRelative = exports.isDate = exports.isString = exports.isInteger = exports.isNumber = exports.isUndefined = exports.isDefined = void 0;
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const errors_1 = __webpack_require__(/*! ../errors */ "./src/errors.ts");
const settings_1 = __webpack_require__(/*! ../settings */ "./src/settings.ts");
const conversions_1 = __webpack_require__(/*! ./conversions */ "./src/impl/conversions.ts");
const intl_next_1 = tslib_1.__importDefault(__webpack_require__(/*! ../types/intl-next */ "./src/types/intl-next.ts"));
/**
 * @private
 */
...
function firstWeekOffset(year, minDaysInFirstWeek, startOfWeek) {
    const fwdlw = (0, conversions_1.isoWeekdayToLocal)((0, conversions_1.dayOfWeek)(year, 1, minDaysInFirstWeek), startOfWeek);
...
function parseZoneInfo(ts, offsetFormat, locale, timeZone) {
    ...
    const parsed = new intl_next_1.default.DateTimeFormat(locale, modified)
        .formatToParts(date)
...
function asNumber(value) {
    ...
    if (typeof value === "boolean" || value === "" || Number.isNaN(numericValue)) {
        throw new errors_1.InvalidArgumentError(`Invalid unit value ${value}`);
    }
    return numericValue;
}
...
const zone_1 = __webpack_require__(/*! ../zone */ "./src/zone.ts");
const IANAZone_1 = __webpack_require__(/*! ../zones/IANAZone */ "./src/zones/IANAZone.ts");
const fixedOffsetZone_1 = __webpack_require__(/*! ../zones/fixedOffsetZone */ "./src/zones/fixedOffsetZone.ts");
const util_1 = __webpack_require__(/*! ./util */ "./src/impl/util.ts");
const invalidZone_1 = __webpack_require__(/*! ../zones/invalidZone */ "./src/zones/invalidZone.ts");
const systemZone_1 = __webpack_require__(/*! ../zones/systemZone */ "./src/zones/systemZone.ts");
...
const VERSION = "5.0.7-beta.0"; // REPLACED WITH WEBPACK
...
class Info {
     ...
     * @return {boolean}
     */
    static hasDST(zone = settings_1.Settings.defaultZone) {
        const proto = datetime_1.DateTime.now().setZone(zone).set({ month: 12 });
...
const util_1 = __webpack_require__(/*! ./impl/util */ "./src/impl/util.ts");
const formatter_1 = __webpack_require__(/*! ./impl/formatter */ "./src/impl/formatter.ts");
const formats_1 = __webpack_require__(/*! ./impl/formats */ "./src/impl/formats.ts");
// eslint-disable-next-line @typescript-eslint/naming-convention
...
function friendlyDateTime(dateTimeish) {
    if (datetime_1.DateTime.isDateTime(dateTimeish)) {
        ...
        throw new errors_1.InvalidArgumentError(`Unknown datetime argument: ${dateTimeish}, of type ${typeof dateTimeish}`);
    }
}
/**
...
class Interval {
    ...
    static after(start, duration) {
        const dur = duration_1.Duration.fromDurationLike(duration), dt = friendlyDateTime(start);
        return new Interval({
            start: dt,
    ...
    static before(end, duration) {
        const dur = duration_1.Duration.fromDurationLike(duration), dt = friendlyDateTime(end);
        return new Interval({
    ...
    static fromISO(text, opts = {}) {
        ...
        if (s && e) {
            ...
            if (startIsValid) {
                const dur = duration_1.Duration.fromISO(e, opts);
                if (dur.isValid) {
                    return Interval.after(start, dur);
                }
            }
            else if (endIsValid) {
                const dur = duration_1.Duration.fromISO(s, opts);
                if (dur.isValid) {
     ...
     * @return {string}
     */
    toLocaleString(formatOpts = formats_1.DATE_SHORT, opts = {}) {
        return this.isValid
            // tslint:disable-next-line:no-non-null-assertion
...
const util_1 = __webpack_require__(/*! ./impl/util */ "./src/impl/util.ts");
const datetime_1 = __webpack_require__(/*! ./datetime */ "./src/datetime.ts");
const digits_1 = __webpack_require__(/*! ./impl/digits */ "./src/impl/digits.ts");
...
const intl_next_1 = tslib_1.__importDefault(__webpack_require__(/*! ./intl-next */ "./src/types/intl-next.ts"));
 ...
 * @implements {Zone}
 */
class IANAZone extends zone_1.Zone {
    _zoneName;
    _valid;
    /**
    ...
    offset(ts) {
        ...
        const asUTC = (0, util_1.objToLocalTS)({
            year: yearAlt || +year,
            month: +month,
            day: +day,
            hour: +adjustedHour,
 ...
 * @implements {Zone}
 */
class FixedOffsetZone extends zone_1.Zone {
    /**
    ...
    get ianaName() {
        return this._fixed === 0
            ? "Etc/UTC"
            : `Etc/GMT${(0, util_1.formatOffset)(-this._fixed, "narrow")}`;
    }
    /**
     * Returns whether the offset is known to be fixed for the whole year:
     ...
     */
    get name() {
        return this._fixed === 0 ? "UTC" : `UTC${(0, util_1.formatOffset)(this._fixed, "narrow")}`;
    }
    /**
 ...
 * @implements {Zone}
 */
class InvalidZone extends zone_1.Zone {
    _zoneName;
 ...
 * @implements {Zone}
 */
class SystemZone extends zone_1.Zone {
    /**
...
//# sourceMappingURL=ts-luxon.cjs.js.map